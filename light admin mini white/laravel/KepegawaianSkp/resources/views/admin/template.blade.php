...
<html>
  ...
  <body class="menu-position-side menu-side-left full-screen with-content-panel">
    <div class="all-wrapper with-side-panel solid-bg-all">ß
          ...
          <div class="search-suggestions-group">
            ...
            <div class="ssg-content">
              <div class="ssg-items ssg-items-boxed">
                <a class="ssg-item" href="/iniTemplate/dist/users_profile_big.html">
                  <div class="item-media" style="background-image: url(img/company6.png)"></div>
                  <div class="item-name">
                    Integ<span>ration</span> with API
                  </div>
                </a><a class="ssg-item" href="/iniTemplate/dist/users_profile_big.html">
      ...
      <div class="layout-w">
        ...
        <div class="menu-mobile menu-activated-on-click color-scheme-dark">
          <div class="mm-logo-buttons-w">
            <a class="mm-logo" href="index.html"><img src="/iniTemplate/dist/img/logo.png"><span>Clean Admin</span></a>
              ...
              <div class="os-dropdown light message-list">
                <ul>
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="/iniTemplate/dist/img/avatar2.jpg">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Phil Jones
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="/iniTemplate/dist/img/avatar3.jpg">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Bekky Simpson
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="/iniTemplate/dist/img/avatar4.jpg">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Alice Priskon
                        ...
                        <table class="table table-bordered table-lg table-v2 table-striped">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <img alt="" src="/iniTemplate/dist/img/flags-icons/us.png" width="25px">
                              </td>
                              <td class="text-right">
                                $245
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <img alt="" src="/iniTemplate/dist/img/flags-icons/fr.png" width="25px">
                              </td>
                              <td class="text-right">
                                $154
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <img alt="" src="/iniTemplate/dist/img/flags-icons/ca.png" width="25px">
                              </td>
                              <td class="text-right">
                                $112
                              </td>

...
class DashboardIndexDua extends Component {
    render() {
        return (
            <div className="content-w">
                ...
                <div className="top-bar color-scheme-transparent masariuman-height103px">
                    <div className="top-menu-controls masariuman-marginleft30px">
                        ...
                        <div className="masariuman-textleft">
                            <span className="masariuman-bold">Dashboard Dua</span> <br/>
                            <small>Manajemen Dashboard Dua</small>
                        </div>
                    </div>
                ...
                <ul className="breadcrumb">
                    <li className="breadcrumb-item">
                        <a href="/it/ruangan">Dashboard Dua</a>
                    </li>
                    <li className="breadcrumb-item">
                            ...
                            <div className="element-wrapper">
                                ...
                                <div className="element-box">
                                    <h5 className="form-header">
                                        Master Dashboard Dua
                                    </h5>
                                    <div className="form-desc">
                                        Manajemen Data Dashboard Dua
                                    </div>
                                    <div>
...
export default DashboardIndexDua;
